...
<?= $this->section('content') ?>
    ...
    <?php endif; ?>
    <form class="row" action="<?= base_url('roomloki/halaman/update/' . $halaman['id_halaman']) ?>" method="post" enctype="multipart/form-data">  
        <?= csrf_field() ?>      
        <div class="col-md-8">
            <input type="text" name="judul" placeholder="Judul" class="form-control mb-2" value="<?= esc($halaman['judul']) ?>">
            <textarea class="d-none" id="konten" name="isi_halaman"><?= esc($halaman['isi_halaman']) ?></textarea>
        </div>
        <div class="col-md-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="img-upload-galery">
                        ...
                        <div class="gallery">
                            ...
                            <img width="100%" class="img-del" height="auto" src="<?=base_url().'uploads/thumbnail/'.esc($halaman['gambar'])?>">
                            <?php endif; ?>
                        </div>
   ...
   <script>
    $(document).ready(function() {
        $('#konten').summernote({
            ...
            codeviewFilter: false,  // <== MATIKAN FILTERING
            codeviewIframeFilter: false, // <== IZINKAN IFRAME
            callbacks: {
