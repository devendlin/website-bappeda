...
<div class="d-flex align-items-center justify-content-between mb-4">
    <div class="h4 m-0 text-muted" style="font-weight: 300;">Tambah Dokumentasi</div>
</div>
            ...
            <div class="card-body">
                <form id="formTambahDokumentasi" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="judul" class="form-control" required placeholder="Contoh: Rapat Koordinasi SAKIP 2025">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="deskripsi" class="form-control" rows="3" placeholder="Jelaskan kaitan kegiatan tersebut secara singkat..."></textarea>
                    </div>
...
$(document).ready(function() {
    ...
    $('#formTambahDokumentasi').on('submit', function(e) {
        ...
        if (selectedPhotos.length === 0) {
            Swal.fire('Peringatan', 'Silakan pilih minimal satu foto dokumentasi', 'warning');
            return;
        }
        ...
        $.ajax({
            url: "<?= base_url('roomloki/dokumentasi/simpan') ?>",
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
